...
def manuscript_v7(k: dict[str, str], refs: dict[str, int]) -> str:
    ...
    abstract = (
        ...
        f"GraphSAGE showed large subject-associated losses in Andersson and Thrane, with patient RLI values of {k['andersson_gs']} and {k['thrane_gs']}. "
