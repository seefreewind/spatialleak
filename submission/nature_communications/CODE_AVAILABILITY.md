...
The release includes `src/`, `scripts/`, `configs/`, `tests/`, frozen target-panel metadata and paper assets needed to reproduce the submitted figures from processed results. The paper-asset smoke test is:
